...
class TrainsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create train" do
    assert_difference("Train.count") do
      post trains_url, params: { train: { train_capacity: @train.train_capacity, train_id: @train.train_id, train_name: @train.train_name } }
    end
  ...
  test "should update train" do
    patch train_url(@train), params: { train: { train_capacity: @train.train_capacity, train_id: @train.train_id, train_name: @train.train_name } }
